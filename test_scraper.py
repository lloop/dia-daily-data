...
class TestProductPageFiltering(unittest.TestCase):
    ...
    def test_matches_a_configured_non_tomato_product_type(self):
        html = '''
        <ul class="info-label__list"><li>Tipo de producto: Aceite de oliva</li></ul>
        '''
        self.assertTrue(has_product_type(html, 'Tipo de producto: Aceite de oliva'))
